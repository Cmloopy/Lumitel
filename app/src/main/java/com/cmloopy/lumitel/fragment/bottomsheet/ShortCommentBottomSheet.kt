...
import com.cmloopy.lumitel.databinding.BottomSheetShortCommentBinding
import com.cmloopy.lumitel.viewmodels.ShortViewModel
import com.google.android.material.bottomsheet.BottomSheetDialog
import com.google.android.material.bottomsheet.BottomSheetDialogFragment

class ShortCommentBottomSheet: BottomSheetDialogFragment() {

    private lateinit var binding: BottomSheetShortCommentBinding
    ...
    companion object {
        fun newInstance(video: ShortVideo) { }
    }
    ...
    override fun onCreateView(
        ...
        binding = BottomSheetShortCommentBinding.inflate(inflater, container, false)
        return binding.root
    }
